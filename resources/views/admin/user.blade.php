            ...
            <div class="modal-body">
                <form action="{{url('/user/addUserExcel')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <a href="{{url('storage/ExcelFiles/User/UserExcelFormat.xlsx')}}" id="download" download class="btn btn-success"><i class="fas fa-cloud-download-alt"></i>Download
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <form autocomplete="off" action="{{url('/user/addUser')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker" name="role" required id="Role">
                    ...
                    <div class="modal-footer m-0 p-0 pt-3">
                        <!-- <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Close</button> -->
                        <button type="submit" disabled id="addBtn" class="btn btn-primary font-weight-bold">
                            <i class="fas fa-plus"></i>
    ...
    <div class="card card-custom ">
        <div class="card-header flex-wrap">
            <div class="card-title">
                <h3 class="card-label">Office Users </h3>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-center">
                            <img src="{{$data->profileImage != null ? $data->profileImage : 'media\blank.png'}}" onerror="this.src='media/blank.png'" alt="User Image" style="height: 50px; width: 50px;">
                        </td>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <i class="fas fa-times" style="font-size: 20px;" {{$role->id == $data->role ? 'selected' : ''}}></i>
                                    </button>
                                </div>

                                <form action="{{url('/user/editUser')}}" method="post">
                                    @csrf
                                    <div class="modal-body">
                    ...
                    <div class="modal fade" id="deleteModal{{$data->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                ...
                                <form action="{{url('/user/deleteUser')}}" id="UserDeleteForm{{$data->id}}" method="post">
                                    @csrf
                                    <input type="hidden" value="{{$data->id}}" name="hiddenId">
                                    <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" id="delYes" class="btn btn-danger">
                                            <i class="fas fa-trash-alt" style="font-size: 20px;"></i>Yes</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script>
    ...
    function checkEmail() {
        ...
        if (emailRegex.test(email)) {
            ...
            emailTitle.innerHTML = "Email is not valid";
            emailTitle.style.color = "red";
            document.getElementById('addBtn').disabled = true;
            document.getElementById("Name").style.borderColor = "red";
        }
    ...
    function checkPhone() {
        ...
        if (phoneRegex.test(phone)) {
            ...
            phoneTitle.innerHTML = "Phone is not valid";
            phoneTitle.style.color = "red";
            document.getElementById('addBtn').disabled = true;
            document.getElementById("Name").style.borderColor = "red";
        }
