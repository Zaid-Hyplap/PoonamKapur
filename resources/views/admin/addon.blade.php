                                            ...
                                            <form action="{{url('/addon/updateAddon')}}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label style="font-weight: bold;" for="Name"> UID <span style="color: red;">&#42</span></label>
                                                            <input type="text" class="form-control" onkeyup="checkUUID({{$data->id}})" id="UID{{$data->id}}" name="UID" value="{{$data->UID}}" required>
                                                            <label for="" id="uidTitle{{$data->id}}"></label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label style="font-weight: bold;" for="Name">Unit <span style="color: red;">&#42</span></label>
                                                            <select class="form-control selectpicker" id="Unit" name="unit" required>
                                                                <option value="gms" {{$data->unit == 'gms' ? 'selected' : ''}}>Grams</option>
