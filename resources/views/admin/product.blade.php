        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{url('/product/importProductMacro')}}" method="post">
                        <div class="row">
                            @csrf
                            <div class="col-sm-12 text-left">
                                <div class="form-group">
                    ...
                    <form action="{{url('/product/importProductRecipe')}}" method="post">
                        <div class="row">
                            @csrf
                            <div class="col-sm-12 text-left">
                                <div class="form-group">
                        ...
                        <tr>
                            ...
                            <td class="table-action text-center">
                                <div>
                                    ...
                                    <a href="{{url('/product/updateProduct')}}/{{$data->UID}}" class="btn btn-icon btn-outline-warning has-ripple"><i class="fas fa-pen"></i></a>
